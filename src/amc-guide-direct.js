(function(){
  function add(){
    ...
    var c={id:'ai-amc-guide',title:'AI-Aware Hiring Guide for Academic Medical Centers',category:'ai-governance',role:'Featured interactive governance artifact',summary:'Interactive academic medical center guide.',skills:['AI governance','Workforce strategy','Interactive guide'],audience:['Dean','Senior leadership'],strategic:'Practical responsible AI process artifact.',sourceFile:'AI-Aware Hiring Guide',tags:['AI governance','Academic medical centers'],featured:true,confidential:false,cleanFile:null,fullArtifactUrl:null,liveUrl:'https://datadrivenmed.github.io/AI-Aware-Hiring-Guide/',liveLabel:'Launch guide'};
